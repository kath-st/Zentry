...
import json
from .services.control_acceso_service import ControlAccesoService

# Inicializamos el servicio de control de acceso.
# ¡Cuidado!: En entornos de producción con múltiples procesos,
# esta inicialización requiere patrones Singleton o cache para asegurar
# que todas las peticiones usen la misma instancia de los Hash Sets.
...
def validar_acceso(request):
    ...
    if request.method == 'POST':
        try:
            ...
            resultado = control_service.validar_ticket(codigo_ticket)
...
def ver_fila_ingreso(request):
    ...
    fila_actual = list(control_service.fila_ingreso) 
